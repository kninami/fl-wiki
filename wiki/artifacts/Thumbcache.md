...
| Win8/10 | thumbcache_16/32/48/96/256/1024/WIDE.db, thumbcache_idx.db | 동일 |
| Win11 | thumbcache_16/32/48/96/256/768/1280/1920/2560.db, thumbcache_idx.db | 동일 |
...
- **Win11 thumbcache 파일 구성: thumbcache_16/32/48/96/256/768/1280/1920/2560.db** — Win8/10 계열의 1024/WIDE.db 대신 768/1280/1920/2560.db 체계; 뷰 모드에 따라 저장 DB 분기 (→ [[experiments/thumbcache_win11_maxsize_20260604]])
- **DB별 용량 상한 (Win11 실험)**: _16/32≈1 MB, _48≈2 MB, _96≈96.2 MB(3750개), _256≈66.5 MB(6679개), _1280≈65.5 MB(360개), _2560≈1.63 GB(3146개) (→ [[experiments/thumbcache_win11_maxsize_20260604]])
- **EXIF 내장 썸네일이 저장 DB를 결정**: 카메라 사진(EXIF 포함) → _1280, 모바일 사진(EXIF 없거나 소형) → _2560 (→ [[experiments/thumbcache_win11_maxsize_20260604]])
- **원본 파일 삭제 후 엔트리 잔류 및 이미지 복구 실험 확인** — quick_2014 주장과 일치 (→ [[experiments/thumbcache_win11_deletion_persistence_20260604]])
- **최대용량 도달 시 오래된 엔트리 교체 확인** — LRU로 알려져 있으나 FIFO 가능성도 있음; 교체된 엔트리는 Offset 겹침으로 복구 어려울 것으로 예측 (→ [[experiments/thumbcache_win11_deletion_persistence_20260604]])
